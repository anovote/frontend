...
export default function IconMessage({
    ...
    const [alertState, alertDispatch] = useAlert({ message: alertMessage, alertType: alertLevel })
    ...
    return (
        <div style={{ width: 'auto', position: 'relative' }}>
            ...
            <div className="mt-20 is-flex has-content-center-center">{createAlertComponent(alertState)}</div>
        </div>
    )
}
